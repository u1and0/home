...
# 
# c.IPythonKernel.help_links = [{'url': 'http://docs.python.org/3.5', 'text': 'Python'}, {'url': 'http://ipython.org/documentation.html', 'text': 'IPython'}, {'url': 'http://docs.scipy.org/doc/numpy/reference/', 'text': 'NumPy'}, {'url': 'http://docs.scipy.org/doc/scipy/reference/', 'text': 'SciPy'}, {'url': 'http://matplotlib.org/contents.html', 'text': 'Matplotlib'}, {'url': 'http://docs.sympy.org/latest/index.html', 'text': 'SymPy'}, {'url': 'http://pandas.pydata.org/pandas-docs/stable/', 'text': 'pandas'}]
...
# c.InteractiveShell.banner1 = 'Python 3.5.1 |Anaconda custom (64-bit)| (default, Feb 16 2016, 09:49:46) [MSC v.1900 64 bit (AMD64)]\nType "copyright", "credits" or "license" for more information.\n\nIPython 5.1.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'

...
# The name of a Pygments style to use for syntax highlighting:  algol_nu,
# perldoc, vim, murphy, manni, pastie, paraiso-dark, rrt, colorful, emacs,
# friendly, bw, xcode, lovelace, monokai, tango, autumn, fruity, default,
# paraiso-light, borland, igor, vs, algol, trac, native
